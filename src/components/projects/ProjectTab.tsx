    ...
    <section className="">
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-3xl xl:text-4xl dark:text-white">
            {header}
          </h1>
        ...
        <div className="hidden md:flex md:flex-col lg:mt-0 lg:col-span-5 lg:flex">
          <Image
            isBlurred
