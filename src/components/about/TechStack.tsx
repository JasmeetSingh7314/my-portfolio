...
export default function TechStack() {
  return (
    <section className="mb-20 mx-2 dark:text-gray-100">
      <div className="container max-w-xl p-2 sm:p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-x-24 xl:gap-x-96 gap-y-20  ">
          {techStack.map((tech, id) => (
            <svg
              ...
              className="w-28 h-28 mx-2 sm:mx-10 my-6 fill-current md:mx-12 lg:m-0 dark:text-gray-400"
            >
